...
ALTER TABLE "products" ADD CONSTRAINT "products_images_images_id_fk" FOREIGN KEY ("images") REFERENCES "public"."images"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
